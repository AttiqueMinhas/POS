 ...
 *   https://datatables.net/download/#dt/dt-2.1.3/b-3.1.1/b-html5-3.1.1/r-3.0.2/sc-2.4.3
 *
 * Included libraries:
 *   DataTables 2.1.3, Buttons 3.1.1, HTML5 export 3.1.1, Responsive 3.0.2, Scroller 2.4.3
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "dt/dt-2.1.3/b-3.1.1/b-html5-3.1.1/r-3.0.2/sc-2.4.3",
